...
object ArrayListType : Type() {

    override fun isSatisfy(typeName: TypeName): Boolean =
        (typeName as? ParameterizedTypeName)?.rawType.toString() == ArrayList::class.java.name
    ...
    override fun getPropertyDefaultValue(element: Element, typeName: TypeName): CodeBlock {
        ...
        return CodeBlock.builder().add("%L", "arrayListOf<${decidedTypeName}>()").build()
    }
